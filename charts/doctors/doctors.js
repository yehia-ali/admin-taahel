        ...
        function (ec) {
            ...
            var topCategoryChartOptions = {
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['علاج طبيعي', 'نفسي', 'علاج وظيفي', 'اجتماعي', 'نطق وتخاطب', 'علاج ترويحي', 'ارشاد وتوجيه أسري', 'تعلم صعوبات'],
                    textStyle: {
                        color: '#FFF'
                    },
                },
                ...
                // Add custom colors
                color: ['#ffd322', '#ca80ff',, '#ff654f',, '#ffa422',, '#a74fff',, '#fffa70',, '#e3ffdc',, '#1fff6e',],
                ...
                series: [
                    {
                        ...
                        data: [
                            {value: 335, name: 'علاج طبيعي'},
                            {value: 100, name: 'نفسي'},
                            {value: 50, name: 'علاج وظيفي'},
                            {value: 60, name: 'نطق وتخاطب'},
                            {value: 80, name: 'علاج ترويحي'},
                            {value: 70, name: 'ارشاد وتوجيه أسري'},
                            {value: 6, name: 'تعلم صعوبات'},
                        ]
                    }
                ]
            };
