        ...
        function (ec) {
            ...
            var topCategoryChartOptions = {
                ...
                legend: {
                    orient: 'vertical',
                    x: 'left',
                    data: ['المعلقة','المرفوضة','المؤكدة','المكتملة','الغير مكتملة'],
                    textStyle: {
                        color: '#FFF'
                    },
                },
                ...
                // Add custom colors
                color: ['#ffd322', '#ff827d', '#ff2a27', '#ffa422', '#1fff43'],
                ...
                series: [
                    {
                        ...
                        data: [
                            {value: 335, name: 'المعلقة'},
                            {value: 335, name: 'المرفوضة'},
                            {value: 335, name: 'المؤكدة'},
                            {value: 335, name: 'المكتملة'},
                            {value: 200, name: 'الغير مكتملة'}
                        ]
                    }
                ]
            };
            ...
            /************************************
             *       Customer الطلبات في كل دولة Stats      *
             ************************************/
                // Initialize chart
                // ------------------------------
